...
class EmployeesDB:
    ...
    def create_new_company(self, name: str, desc: str):
        """
        создаём компанию в базе данных с названием comp(str) и описанием desc(str) через SQL запрос в БД
        """
    ...
    def get_max_id_company(self):
        """
        получаем максимальный id организации через SQL запрос из БД
        """
    ...
    def delete_company(self, max_id_value: int):
        """
        удаляем организацию с соответствующим id через SQL запрос из БД
        """
    ...
    def create_new_employee(self,  first_name: str, last_name: str, middle_name: str, phone: str, email: str, birthdate: str, avatar_url: str, company_id: int, is_active: bool):
        """
        в этом методе передаём данные сотрудника и создаём его для соответствующей компании по id через SQL запрос в БД
        """
    ...
    def select_all_employees(self, max_id_comp: int):
        """
        в этом методе получаем список сотрудников по id через SQL запрос в БД
        """
    ...
    def get_max_id_employee(self):
        """
        получаем максимальный id сотрудника через SQL запрос из БД
        """
    ...
    def edit_employee(self, employeeId: int, new_lastName: str, new_email: str, new_url: str, new_phone: str, new_isActive: bool):
        """
        в этом методе передаём новые данные сотрудника и изменяем их для сотрудника с соответствующим id через SQL запрос в БД
        """
    ...
    def delete_employee(self, id: int):
        """
        удаляем сотрудника по id через SQL запрос в БД
        """
